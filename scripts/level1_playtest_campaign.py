...
PERSONAS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        'seed': 211,
        'actions': [
            'look around', 'wait', 'wait', 'wait', 'wait', 'wait',
            'step back from the door', 'cooperate', 'wash myself', 'eat the food',
            'sleep', 'wait', 'wait', 'wait', 'wait',
            'Sarel', 'a fishing village', 'my brother',
            'wait', 'wait', 'wait', 'yes',
            'look around', 'ask Nessa who she is',
            'I will keep your secret', 'ask her what she wants',
            'wait', 'look around',
        ],
    },
    {
        'id': 'nessa_trust_betray',
        'seed': 212,
        'actions': [
            'look around', 'wait', 'wait', 'wait', 'wait', 'wait',
            'step back from the door', 'cooperate', 'wash myself', 'eat the food',
            ...
            'wait', 'wait', 'wait', 'yes',
            'look around', 'ask Nessa who she is',
            'tell the staff what she said', 'report Nessa to staff',
            'wait', 'look around',
        ],
    },
    {
        'id': 'hadrik_witness_protect',
        'seed': 213,
        'actions': [
            'look around', 'wait', 'wait', 'wait',
            'ask the woman her name', 'ask where I am',
            'step back from the door', 'cooperate',
            'ask why they need me to move',
            'I will protect the quiet one if I can',
            'wash myself', 'eat the food', 'sleep',
            'wait', 'wait', 'Sarel', 'a fishing village', 'my brother',
            'wait', 'yes', 'look around',
        ],
    },
    {
        'id': 'iven_exploit',
        ...
        'actions': [
            'look around', 'wait', 'wait', 'wait', 'wait', 'wait',
            'step back', 'cooperate', 'wash myself', 'eat', 'sleep',
            'wait', 'wait', 'wait', 'Sarel', 'village', 'brother',
            'wait', 'wait', 'yes',
            'look around', 'ask Iven about Heaven',
            'give me everything you know', 'tell me again',
            'you owe me answers', 'ask again',
            'wait', 'look around',
        ],
    },
    {
        'id': 'maelin_credibility',
        'seed': 215,
        'actions': [
            'look around', 'wait', 'wait', 'wait', 'wait', 'wait',
            'step back', 'cooperate', 'wash myself', 'eat', 'sleep',
            'wait', 'wait', 'wait', 'Sarel', 'a fishing village', 'my brother',
            'wait', 'wait', 'ask why these questions',
            'I do not trust your contract', 'why should I believe you',
            'no', 'wait', 'look around',
        ],
    },
    {
        ...
        'seed': 216,
        'actions': [
            'look around', 'wait', 'wait', 'wait', 'wait',
            'ask the anxious orderly their name',
            'I will step back carefully', 'cooperate',
            'I will not make trouble', 'wash myself', 'eat',
            'thank you for being careful', 'sleep',
            'wait', 'wait', 'Sarel', 'village', 'brother',
            'wait', 'yes', 'look around',
        ],
    },
]
    ...
    with traces_path.open('w', encoding='utf-8') as tf, short_jsonl_path.open('w', encoding='utf-8') as sf:
        for i, action in enumerate(actions, 1):
            ...
            record = {
                ...
                'room_id': getattr(session.world.facility, 'room_id', None) if session.world.facility else None,
                'present_ids': list(getattr(getattr(session.world.facility, 'arc', None), 'present_ids', None) or []) if session.world.facility else [],
                'enactment': enactment,
